/*
lib_graphics/s_region.h - Header file for graphics.library
	struct Region
...
#ifndef _LIB_GRAPHICS_S_REGION_H_
#define _LIB_GRAPHICS_S_REGION_H_
...
/* Kickstart 2.0 */
#define LIB_GRAPHICS_S_REGION_SIZE 12

/* Structure for simulated object */
struct lib_graphics_s_region_struct {
        mmu_entry_t *entry;
	struct Region *real;
};
typedef struct lib_graphics_s_region_struct lib_graphics_s_region_t;
