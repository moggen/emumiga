/*
lib_exec/s_execbase.h - Header file for simulation of exec.library
...
#ifndef _LIB_EXEC_S_EXECBASE_H_
#define _LIB_EXEC_S_EXECBASE_H_
...
class s_execbase : public s_library {
    public:
	static int init();
	static void cleanup();
};
