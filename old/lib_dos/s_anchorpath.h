/*
lib_dos/s_anchorpath.h - Header file for dos.library
	struct AnchorPath
...
#ifndef _LIB_DOS_S_ANCHORPATH_H_
#define _LIB_DOS_S_ANCHORPATH_H_
...
/* Kickstart 2.0 */
#define LIB_DOS_S_ANCHORPATH_SIZE 282

/* Structure for simulated object */
struct lib_dos_s_anchorpath_struct {
	mmu_entry_t *entry;
	struct AnchorPath *real;
	int userSpace;
};
typedef struct lib_dos_s_anchorpath_struct lib_dos_s_anchorpath_t;
