/*
lib_dos/f_output.c - dos.library Output function
...
****************************/
int lib_dos_f_Output(emumsg_syscall_t *msg __attribute__((unused)))
{
	DEBUG(4) dprintf("dos.library: lib_dos_f_Output() called\n");
...
int lib_dos_f_Output_3(emumsg_syscall_t *msg)
{
	...
	DEBUG(4) dprintf("dos.library: lib_dos_f_Output_3() called\n");
