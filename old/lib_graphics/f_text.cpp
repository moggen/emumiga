/*
lib_graphics/f_text.c - graphics.library Text function
...
int lib_graphics_f_Text(emumsg_syscall_t *msg)
{
	...
	DEBUG(4) dprintf("graphics.library: lib_graphics_f_Text() called\n");
	...
	if(rastport == NULL) {
		DEBUG(1) dprintf("Error: graphics.library: lib_graphics_f_Text: RastPort struct pointer is invalid\n");
		return HOOK_END_PROC;
	}

	string_real = vptr(cpu->a[0]);   /* TODO: Better check */
	if(string_real == NULL) {
		DEBUG(1) dprintf("Error: graphics.library: lib_graphics_f_Text: Stringd pointer is invalid\n");
		return HOOK_END_PROC;
	}
...
{
	DEBUG(4) dprintf("graphics.library: lib_graphics_f_Text_3() called\n");
