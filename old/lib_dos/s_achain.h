/*
lib_dos/s_achain.h - Header file for dos.library
	struct AChain
...
#ifndef _LIB_DOS_S_ACHAIN_H_
#define _LIB_DOS_S_ACHAIN_H_
...
/* Kickstart 2.0 */
#define LIB_DOS_S_ACHAIN_SIZE 274

/* Structure for simulated object */
struct lib_dos_s_achain_struct {
        mmu_entry_t *entry;
	struct AChain *real;
};
typedef struct lib_dos_s_achain_struct lib_dos_s_achain_t;
