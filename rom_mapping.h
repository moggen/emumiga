/*
rom_mapping.h - Virtual memory mapping in ROM memory
...
namespace emumiga {
   class rom_mapping : public virtual_mapping {
     public:
      // Constructors
      rom_mapping(uint32_t length, uint8_t const *real_memory);
