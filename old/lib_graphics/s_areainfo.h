/*
lib_graphics/s_areainfo.h - Header file for graphics.library
	struct AreaInfo
...
#ifndef _LIB_GRAPHICS_S_AREAINFO_H_
#define _LIB_GRAPHICS_S_AREAINFO_H_
...
/* Kickstart 2.0 */
#define LIB_GRAPHICS_S_AREAINFO_SIZE 24

/* Structure for simulated object */
struct lib_graphics_s_areainfo_struct {
        mmu_entry_t *entry;
	struct AreaInfo *real;
	void *buffer;
};
typedef struct lib_graphics_s_areainfo_struct lib_graphics_s_areainfo_t;
