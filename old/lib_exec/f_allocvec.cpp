/*
lib_exec/f_allocvec.c - exec.library AllocVec function
...
int lib_exec_f_AllocVec(emumsg_syscall_t *msg)
{
	...
	DEBUG(4) dprintf("exec.library: lib_exec_f_AllocVec() called\n");
...
{
	/* Make real syscall */
	msg->arg[0]._aptr = AllocVec(msg->arg[0]._ulong, msg->arg[1]._ulong);
...
int lib_exec_f_AllocVec_3(emumsg_syscall_t *msg)
{
	...
	DEBUG(4) dprintf("exec.library: lib_exec_f_AllocVec_3() called\n");
