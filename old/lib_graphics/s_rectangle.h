/*
lib_graphics/s_rectangle.h - Header file for graphics.library
	struct Rectangle
...
#ifndef _LIB_GRAPHICS_S_RECTANGLE_H_
#define _LIB_GRAPHICS_S_RECTANGLE_H_
...
/* Kickstart 2.0 */
#define LIB_GRAPHICS_S_RECTANGLE_SIZE 8

/* Structure for simulated object */
struct lib_graphics_s_rectangle_struct {
	mmu_entry_t *entry;
	struct Rectangle *real;
	int userSpace;
};
typedef struct lib_graphics_s_rectangle_struct lib_graphics_s_rectangle_t;
