/*
lib_exec/s_iorequest.h - Header file for exec.library
	struct IORequest
...
#ifndef _LIB_EXEC_S_IOREQUEST_H_
#define _LIB_EXEC_S_IOREQUEST_H_
...
/* Kickstart 2.0 */
#define LIB_EXEC_S_IOREQUEST_SIZE 32

/* Structure for simulated object */
struct lib_exec_s_iorequest_struct {
        mmu_entry_t *entry;
...
typedef struct lib_exec_s_iorequest_struct lib_exec_s_iorequest_t;
