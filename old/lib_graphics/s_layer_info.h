/*
lib_graphics/s_layer_info.h - Header file for graphics.library
	struct Layer_Info
...
#ifndef _LIB_GRAPHICS_S_LAYER_INFO_H_
#define _LIB_GRAPHICS_S_LAYER_INFO_H_
...
/* Kickstart 2.0 */
#define LIB_GRAPHICS_S_LAYER_INFO_SIZE 102

/* Structure for simulated object */
struct lib_graphics_s_layer_info_struct {
        mmu_entry_t *entry;
	struct Layer_Info *real;
};
typedef struct lib_graphics_s_layer_info_struct lib_graphics_s_layer_info_t;
