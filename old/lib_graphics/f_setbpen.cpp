/*
lib_graphics/f_setbpen.c - graphics.library
	SetBPen function
...
int lib_graphics_f_SetBPen(emumsg_syscall_t *msg)
{
	...
	DEBUG(4) dprintf("graphics.library: lib_graphics_f_SetBPen() called\n");
	...
	if(cpu->a[1] == 0 ) {
		DEBUG(1) dprintf("Error: graphics.library: lib_graphics_f_SetBPen: RastPort must be provided.\n");
		return HOOK_END_PROC;
	}

	rastport = lib_graphics_s_rastport_get_vaddr(cpu->a[1]);
	if(rastport == NULL) {
		DEBUG(1) dprintf("Error: graphics.library: lib_graphics_f_SetBPen: RastPort pointer is invalid\n");
		return HOOK_END_PROC;
	}
...
int lib_graphics_f_SetBPen_3(emumsg_syscall_t *msg)
{
	...
	DEBUG(4) dprintf("graphics.library: lib_graphics_f_SetBPen_3() called\n");
