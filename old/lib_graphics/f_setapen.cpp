/*
lib_graphics/f_setapen.c - graphics.library
	SetAPen function
...
int lib_graphics_f_SetAPen(emumsg_syscall_t *msg)
{
	...
	DEBUG(4) dprintf("graphics.library: lib_graphics_f_SetAPen() called\n");
	...
	if(cpu->a[1] == 0 ) {
		DEBUG(1) dprintf("Error: graphics.library: lib_graphics_f_SetAPen: RastPort must be provided.\n");
		return HOOK_END_PROC;
	}

	rastport = lib_graphics_s_rastport_get_vaddr(cpu->a[1]);
	if(rastport == NULL) {
		DEBUG(1) dprintf("Error: graphics.library: lib_graphics_f_SetAPen: RastPort pointer is invalid\n");
		return HOOK_END_PROC;
	}
...
int lib_graphics_f_SetAPen_3(emumsg_syscall_t *msg)
{
	...
	DEBUG(4) dprintf("graphics.library: lib_graphics_f_SetAPen_3() called\n");
