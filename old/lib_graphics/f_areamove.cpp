/*
lib_graphics/f_areamove.c - graphics.library
	AreaMove function
...
int lib_graphics_f_AreaMove(emumsg_syscall_t *msg)
{
	...
	DEBUG(4) dprintf("graphics.library: lib_graphics_f_AreaMove() called\n");
	...
	if(cpu->a[1] == 0 ) {
		DEBUG(1) dprintf("Error: graphics.library: lib_graphics_f_AreaMove: RastPort must be provided.\n");
		return HOOK_END_PROC;
	}

	rastport = lib_graphics_s_rastport_get_vaddr(cpu->a[1]);
	if(rastport == NULL) {
		DEBUG(1) dprintf("Error: graphics.library: lib_graphics_f_AreaMove: RastPort pointer is invalid\n");
		return HOOK_END_PROC;
	}
...
int lib_graphics_f_AreaMove_3(emumsg_syscall_t *msg)
{
	...
	DEBUG(4) dprintf("graphics.library: lib_graphics_f_AreaMove_3() called\n");
