/*
lib_graphics/s_gelsinfo.h - Header file for graphics.library
	struct GelsInfo
...
#ifndef _LIB_GRAPHICS_S_GELSINFO_H_
#define _LIB_GRAPHICS_S_GELSINFO_H_
...
/* Kickstart 2.0 */
#define LIB_GRAPHICS_S_GELSINFO_SIZE 38

/* Structure for simulated object */
struct lib_graphics_s_gelsinfo_struct {
        mmu_entry_t *entry;
	struct GelsInfo *real;
};
typedef struct lib_graphics_s_gelsinfo_struct lib_graphics_s_gelsinfo_t;
